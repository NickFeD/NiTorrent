...
{
    public static TorrentLifecycleState FromPhase(TorrentPhase phase)
        => phase switch
        {
            TorrentPhase.WaitingForEngine or TorrentPhase.EngineStarting => TorrentLifecycleState.WaitingForEngine,
    ...
    public static TorrentPhase ToPhase(TorrentLifecycleState state)
        => state switch
        {
